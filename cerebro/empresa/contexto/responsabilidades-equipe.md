# Responsabilidades da Equipe — Dra. Lígia Toledo Serviços Médicos
...
Centralizar as responsabilidades de cada pessoa da equipe para evitar perda de informação quando atividades forem repassadas de uma colaboradora para outra.

Este documento deve ajudar a responder rapidamente:

- Quem é responsável por cada atividade?
- O que cada pessoa precisa executar?
- Qual é a frequência da tarefa?
- Quem acompanha ou valida?
...
## Como registrar novas responsabilidades

Para cada atividade, registrar sempre que possível:

| Campo | Como preencher |
|---|---|
| Atividade | Nome objetivo da tarefa |
| Responsável principal | Quem executa ou garante que aconteça |
| Apoio | Quem ajuda, envia informação ou depende da tarefa |
| Frequência | Diário, semanal, mensal, sob demanda etc. |
| Ferramenta/canal | iClinic, WhatsApp, Telegram, Instagram, planilha etc. |
| Critério de conclusão | Como saber que a tarefa foi finalizada |
| Observações | Regras, exceções, detalhes importantes |
| Status | Ativa, em transição, pausada ou encerrada |

---

# Matriz geral de responsabilidades
...
## Reginaldo Yukio Kawamoto

### Responsabilidades atuais

| Atividade | Frequência | Ferramenta/canal | Critério de conclusão | Status | Observações |
|---|---|---|---|---|---|
| Gestão de operações | Contínua | Telegram / sistemas internos | Rotina acompanhada e prioridades definidas | Ativa | Inclui organização e redistribuição de atividades. |
| Financeiro | A detalhar | A detalhar | A detalhar | A detalhar | Detalhar pagamentos, controle, conferências e aprovações. |
| Atendimento | A detalhar | A detalhar | A detalhar | A detalhar | Detalhar participação direta no atendimento. |
| Marketing | A detalhar | Instagram / tráfego / social media | A detalhar | A detalhar | Interface com social media, tráfego e calendário de marketing. |

### Histórico de mudanças

| Data | Mudança | Origem da informação |
|---|---|---|
| 2026-08-13 | Documento criado para centralizar responsabilidades da equipe. | Áudio de Reginaldo no Telegram. |
...
- [ ] Listar atividades financeiras sob responsabilidade direta.
- [ ] Listar atividades de operação sob responsabilidade direta.
- [ ] Listar decisões que precisam passar por Reginaldo.
- [ ] Separar o que é execução direta vs. acompanhamento/cobrança.

## Paola

- [ ] Detalhar rotina diária de atendimento.
- [ ] Detalhar responsabilidades comerciais/vendas.
- [ ] Definir quais follow-ups ficam com Paola e quais ficam com Tamires.
- [ ] Registrar canais utilizados e critérios de conclusão.

## Tamires

- [ ] Detalhar rotina de follow-up iClinic.
- [ ] Definir onde ficará a lista operacional de pacientes ativos + Instagram encontrado + status de inclusão no Close Friends.
- [ ] Registrar frequência, horários e critérios de prioridade.
- [ ] Definir regras de escalonamento para Reginaldo, Paola ou Dra. Lígia.
- [ ] Registrar modelos de mensagem, se houver.
